# HRMobileRepo — Mobile R1.4.24 Reports Studio Redesign

إعادة هيكلة كاملة لقسم التقارير: واجهة احترافية، قوالب تقارير، تخصيص الأعمدة، معاينة رسمية، Excel منسق، وPDF/طباعة A4 بهوية مؤسسية وخطوط المشروع. لا تغيير على البيانات أو Windows Master Bridge.

# HRMobileRepo — Mobile R1.4.23 Updates + Quality Merge

دمج مركز جودة البيانات داخل مركز التحديثات بدون تغيير بنية مركز التحديثات الحالية. زر جودة البيانات المستقل أزيل من التنقل، والنواقص بقيت في تبويبها الحالي، بينما أضيفت فقط الفحوص غير المكررة مثل اكتمال البيانات والتكرار المحتمل للرقم الوظيفي ورقم الهوية. لا تغيير على data/ أو Windows Master Bridge أو مسار PDF في هذا الإصدار.
...
## R1.4.22 — PDF Blank Page Fix
- إصلاح ملف PDF الأبيض على Android WebView عبر منع التقاط عنصر نهائي موضوع خارج الشاشة.
- يتم تحويل صورة البطاقة الملائمة وهي موجودة ضمن مساحة A4 فعلية ثم تُزال مباشرة بعد إنشاء الملف.
- لا تغيير على البيانات أو Windows Master أو مركز التحديثات.
