# HRMobileRepo — Mobile R1.4.15

تحديث واجهة الهاتف لإضافة شريط تحميل/حفظ PDF داخل بطاقة الموظف، وتنظيف تبويب الإدارة ليبقى للنسخ الاحتياطية وسجل العمليات فقط.

- زر بطاقة الموظف أصبح: تحميل بطاقة الموظف PDF.
- صفحة البطاقة تحتوي زر تحميل / حفظ PDF واضح داخل الهاتف.
- تبويب الإدارة لم يعد يعرض قوائم الموظفين أو Windows Master.
- تبويب الإدارة يعرض سجل العمليات والنسخ الاحتياطية فقط.
- لا تغيير على بيانات الموظفين أو Windows أو GitHub.

# HRMobileRepo — Mobile R1.4.14
