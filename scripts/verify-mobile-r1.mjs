...
const expectedRelease = 'MOBILE-R1.4.46-ADAPTIVE-REPORT-DESIGN-PHASE-2';
if (release !== expectedRelease) fail(`VERSION.txt mismatch: ${release}`);
if (!index.includes(`APP_RELEASE = '${expectedRelease}'`)) fail('APP_RELEASE is not Mobile R1.4.46 Adaptive Report Design Phase 2');
if (!String(manifest.description || '').includes('R1.4.46')) fail('manifest description was not updated');
...
if (!sw.includes("employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18")) fail('R1.4.38 app-shell cache marker missing');
...
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('current PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('current cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('current PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.37 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.37 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.38 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.38 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.39 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.39 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.40 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.40 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.41 cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.42 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.42 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.43 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.43 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.44 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.44 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.45 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.45 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1446-adaptive-reports-phase2-2026.09.18')) fail('R1.4.46 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1446')) fail('R1.4.46 PDF cache marker missing');
