...
const expectedRelease = 'MOBILE-R1.4.45-ADAPTIVE-REPORT-DESIGN-PHASE-1';
if (release !== expectedRelease) fail(`VERSION.txt mismatch: ${release}`);
if (!index.includes(`APP_RELEASE = '${expectedRelease}'`)) fail('APP_RELEASE is not Mobile R1.4.45 Adaptive Report Design Phase 1');
if (!String(manifest.description || '').includes('R1.4.45')) fail('manifest description was not updated');
...
if (!sw.includes("employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18")) fail('R1.4.38 app-shell cache marker missing');
...
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('current PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('current cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('current PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.37 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.37 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.38 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.38 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.39 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.39 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.40 cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.40 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.41 cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.42 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.42 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.43 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.43 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.44 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.44 PDF cache marker missing');
...
if (!sw.includes('employee-registry-mobile-r1445-adaptive-reports-phase1-2026.09.18')) fail('R1.4.45 app-shell cache marker missing');
if (!sw.includes('employee-registry-pdf-downloads-r1445')) fail('R1.4.45 PDF cache marker missing');
